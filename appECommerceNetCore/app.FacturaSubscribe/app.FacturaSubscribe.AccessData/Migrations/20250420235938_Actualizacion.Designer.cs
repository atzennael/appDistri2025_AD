...
namespace app.FacturaSubscribe.DataAccess.Migrations
{
    ...
    [Migration("20250420235938_Actualizacion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("app.FacturaSubscribe.Entities.Models.VentaDetalle", b =>
                {
                    b.HasOne("app.FacturaSubscribe.Entities.Models.Producto", "Producto")
                        .WithMany()
                        .HasForeignKey("ProductoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("app.FacturaSubscribe.Entities.Models.Venta", "Venta")
                        .WithMany()
